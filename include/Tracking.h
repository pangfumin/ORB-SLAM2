...
public:
    ...
    void RunFromROS();
    void RunFromVideoFile(const string &videoInputFile, int seekSecond=0);
    ...
    // used when map is loaded from disk
    void setMapLoaded ();
...
protected:
    ...
    void ProcessImageLocalizer (cv::Mat &img, double timestamp=0);
