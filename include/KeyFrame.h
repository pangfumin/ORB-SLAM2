...
protected:
    ...
    template <class Archive>
    friend void boost::serialization::save (Archive & ar, const ORB_SLAM::KeyFrame &keyframe, const unsigned int version);

    template <class Archive>
    friend void boost::serialization::load (Archive & ar, ORB_SLAM::KeyFrame &keyframe, const unsigned int version);
